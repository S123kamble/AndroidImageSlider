...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvToggle = findViewById(R.id.rv_button);


        canToggle = findViewById(R.id.btn_canvas);
...
//                dialogBuilder.show();  //<-- See This!
        ...
        items.add(new Items("Q1.Question to be asked.Some static question", "Q2.Question to be asked.Some static question", "Q4.Question to be asked.Some static question", "Q5.Question to be asked.Some static question", "Q6.Question to be asked.Some static question", "Q7.Question to be asked.Some static question"));
        items.add(new Items("Q1.Question to be asked.Some static question", "Q2.Question to be asked.Some static question", "Q4.Question to be asked.Some static question", "Q5.Question to be asked.Some static question", "Q6.Question to be asked.Some static question", "Q7.Question to be asked.Some static question"));
        items.add(new Items("Q1.Question to be asked.Some static question", "Q2.Question to be asked.Some static question", "Q4.Question to be asked.Some static question", "Q5.Question to be asked.Some static question", "Q6.Question to be asked.Some static question", "Q7.Question to be asked.Some static question"));
        items.add(new Items("Q1.Question to be asked.Some static question", "Q2.Question to be asked.Some static question", "Q4.Question to be asked.Some static question", "Q5.Question to be asked.Some static question", "Q6.Question to be asked.Some static question", "Q7.Question to be asked.Some static question"));
        items.add(new Items("Q1.Question to be asked.Some static question", "Q2.Question to be asked.Some static question", "Q4.Question to be asked.Some static question", "Q5.Question to be asked.Some static question", "Q6.Question to be asked.Some static question", "Q7.Question to be asked.Some static question"));
