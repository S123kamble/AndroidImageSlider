package com.felixtechlabs.androidimageslider.view;
...
public class Items {
    ...
    public String textView6;

    public Items() {
    }

    public Items(String textView1, String textView2, String textView3, String textView4, String textView5, String textView6) {
